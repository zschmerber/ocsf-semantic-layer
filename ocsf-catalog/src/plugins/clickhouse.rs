//! ClickHouse plugin — stores semantic annotations in a dedicated dictionary table.
...
/// ClickHouse plugin using an in-memory HashMap backend for testing.
...
#[async_trait]
impl CatalogPlugin for ClickHousePlugin {
