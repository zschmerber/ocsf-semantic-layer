//! Iceberg plugin — stores semantic annotations as Iceberg table properties.
...
/// Iceberg plugin using an in-memory HashMap backend for testing.
pub struct IcebergPlugin {
...
impl Default for IcebergPlugin {
    fn default() -> Self {
        Self::new()
    }
}
...
#[async_trait]
impl CatalogPlugin for IcebergPlugin {
